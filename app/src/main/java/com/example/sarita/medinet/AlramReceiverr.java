 ...
 */
public class AlramReceiverr extends WakefulBroadcastReceiver {
    ...
    public void setAlarm(Context context, Calendar calendar, int ID) {
        ...
        Intent intent = new Intent(context, AlramReceiverr.class);
    ...
    public void cancelAlarm(Context context, int ID) {
        ...
        mPendingIntent = PendingIntent.getBroadcast(context, ID, new Intent(context, AlramReceiverr.class), 0);
