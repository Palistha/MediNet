...
import static com.example.sarita.medinet.R.id.starred1;
...
public class Reminderadd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reminder_add);
            ...
            mFAB1 = (FloatingActionButton) findViewById(starred1);
    ...
    public void saveReminder(){
        ...
        if (mActive.equals("true")) {
            if (mRepeat.equals("true")) {
                new AlramReceiverr().setRepeatAlarm(getApplicationContext(), mCalendar, ID, mRepeatTime);
            } else if (mRepeat.equals("false")) {
                new AlramReceiverr().setAlarm(getApplicationContext(), mCalendar, ID);
            }
        }
