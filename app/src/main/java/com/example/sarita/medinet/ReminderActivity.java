...
import com.example.sarita.medinet.R;
...
public class ReminderActivity extends AppCompatActivity {
    ...
    private AlramReceiverr mAlarmReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize alarm
        mAlarmReceiver = new AlramReceiverr();
    }
    ...
    private void selectReminder(int mClickID) {
        ...
        i.putExtra(ReminderActivity.EXTRA_REMINDER_ID, mStringClickID);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public VerticalItemHolder(View itemView, SimpleAdapter adapter) {
                ...
                // Initialize views
                mTitleText = (TextView) itemView.findViewById(R.id.reminder_title);
